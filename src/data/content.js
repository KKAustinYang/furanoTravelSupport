...
const DEMOS=[
  ...
  {cat:'model', icon:'layers', url:'/d/manjiro-staging/index.html', ja:{t:'バーチャルステージング（不動産・空室）',d:'空室の物件写真に、AIが家具を配置。部屋の広さに合わせて3パターンを生成し、Before / After のスライダーで見比べられます。間取りや壁・窓はそのまま、家具だけを足す不動産向けデモ。'},en:{t:'Virtual Staging for Vacant Listings',d:'AI furnishes a vacant room from its listing photo — three layouts per request, compared against the original with a before/after slider. The architecture stays untouched; only furniture is added.'},tags:['Modellix','不動産','ステージング']},
