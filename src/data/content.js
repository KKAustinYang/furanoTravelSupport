...
const DEMOS=[
  {cat:'model', icon:'spark', url:'/d/modellix-studio/index.html', ja:{t:'Modellix Live Studio（展示会キオスク）',d:'その場で撮った1枚の写真から、8つの世界のキャラクターカードをAIが生成。展示会ブースの大型ディスプレイ向けキオスク体験デモ。'},en:{t:'Modellix Live Studio (Expo Kiosk)',d:'One photo taken on the spot becomes a character card in any of 8 worlds. A kiosk experience built for expo-booth displays.'},tags:['Modellix','展示会','Live']},
  ...
  {cat:'model', icon:'user', url:'/d/hair-aurora/index.html', ja:{t:'AIヘアシミュレーション（美容室）',d:'切る前に髪型を試着。お客様の写真と20種のヘアカタログの2枚から、AIが本人の顔のまま髪だけを差し替え。鏡の前のカウンセリングを1枚の画像から始めるデモ。'},en:{t:'AI Hair Simulation (Salon)',d:'Try a haircut on before the first cut. From the client\'s photo plus a style from the 20-cut book, AI swaps only the hair and leaves the face untouched — so the consultation starts from one agreed picture.'},tags:['Modellix','美容室','試着']},
