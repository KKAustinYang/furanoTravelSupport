...
//
//   node demos/manjiro-staging/tools/make-overlays.mjs
//
// なぜ実行時に SVG から描かないのか:
...
const logoSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="${LOGO_W}" height="${Math.round(LOGO_W * 0.26)}" viewBox="0 0 520 136">
  ...
  <text x="128" y="82" font-size="46" letter-spacing="10" fill="#fff" opacity="0.94"
        font-family="'Helvetica Neue',Helvetica,Arial,sans-serif" font-weight="600">MANJIRO</text>
...
`// GENERATED — demos/manjiro-staging/tools/make-overlays.mjs で生成。手で編集しない。
//
